...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "5a9e3ff7-b180-4fe0-b64f-4c8b19008038");
  ...
  return (
    ...
    className='text-center p-6 py-20 lg:px-32 w-full overflow-hidden' id='Contact'>
      ...
      <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        ...
        <button className='bg-blue-600 text-white px-8 py-2 rounded mb-10 cursor-pointer' type='submit'>{result? result : "Send Message"}</button>
      </form>
    </motion.div>
  )
}
